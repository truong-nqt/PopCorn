...
public class Constants {
    ...
    public static final int clickFirst = -1;
    public static final int checkClick = 0;
    public static final int clickSecond = 1;
    public static final int timeFirst = 0;
    public static final int timeEnough = 2000;
    public static final String FIRST_TIME_LAUNCH = "first_time_launch";
    public static final String MOVIE_ID = "movie_id";
    public static final String TV_SHOW_ID = "tv_show_id";
    public static final String MENU_SHOW_ID = "menu_show_id";
